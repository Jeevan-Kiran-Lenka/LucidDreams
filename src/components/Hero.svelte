...
<SectionWrapper>
  <div class="flex flex-col gap-10 flex-1 items-center justify-center pb-10 md:pb-14">
    <h2 class="text-5xl sm:text:6xl md:7xl lg:text-8xl max-w-[1200px] mx-auto w-full text-center font-semibold">
      <span class="text-indigo-400">Gym</span>
      Training <span class="text-slate-600 line-through">Is Hard</span>
      <br/>
    ...
    <p class="text-xl sm:text-2xl md:text-3xl text-center max-w-[1000px] mx-auto w-full">
      ...
      <span class="italic">
        personalized workouts, excercises, explanations, anlaytics.
      </span>
      and much more..
    </p>
    <CtAs/>
